    ...
    <div class="row mt-4 justify-content-center">
      ...
      <div class="col-9">
        ...
        <form class="border-top" novalidate="true" @submit.prevent>
          <div class="mt-3">
            <div class="d-flex flex-column border p-3 bg-light">
              <p class="font-weight-bold font-italic">本方案将用以满足以下客户需求：</p>
              <div class="d-inline-flex">
                <div class="d-inline-flex">
                  <p class="">客户：</p>
                  <p class="font-weight-light font-italic">{{docCustomerRequirement.customer.data.name}}</p>
                </div>
                <div class="d-inline-flex ml-auto">
                  <p class="">日期：</p>
                  <p class="font-weight-light font-italic">{{docCustomerRequirement.data.date | onlyDate}}</p>
                </div>
              </div>
              <div class="d-inline-flex">
                <p class="">需求：</p>
            ...
            <div class="form-row mt-3">
              <div class="col-4 ml-1">
                <div class="form-group">
                  ...
                  <label>方案日期：<validate-error :text="errors.date" /></label>
              ...
              <div class="col">
                <div class="form-group w-100">
                  ...
                  <label>目标产品： <validate-error :text="errors.product" /></label>
                  <div class="d-flex align-items-baseline">
                    <div class="input-group mb-3 mr-auto">
                      <input  type="text"  class="form-control form-control-sm"
                        v-model="doc.product.desc"  @change="onProductInputed"/>
                      <div class="input-group-append">
                        <div class="dropdown">
                          <button  type="button"  class="btn btn-success dropdown-toggle border-0 btn-sm"
                            data-toggle="dropdown"  @click="onProductDropdown"/>
                          <div class="dropdown-menu">
                            <a class="dropdown-item"  v-for="(product, index) in products" :key="index"
            ...
            <div class="form-row">
              <div class="col-6 ml-1">
                  <div class="form-group">
                    <octicon name="shield"/>
                    <label>方案名称：<validate-error :text="errors.title"/></label>
              ...
              <div class="col-2 ml-1">
                  <div class="form-group">
                    <octicon name="shield"/>
                    <label>数量：<validate-error :text="errors.qty"/></label>
              ...
              <div class="col ml-1">
                  <div class="form-group">
                    <octicon name="shield"/>
                    <label>标签：<validate-error :text="errors.tags"/></label>
            ...
            <div class="form-row">
              <div class="col ml-1">
                  <div class="form-group">
                    <label><validate-error :text="errors.desc"/></label>
        ...
        if (this.$route.query.mode == 'edit') {
          await this.$store.dispatch('updateCustomerRequirement', 
            ...
            await this.$store.dispatch('createResource', 
            {
              ...
              data: { ...this.doc, customerRequirement: this.docCustomerRequirement.data.id, creator: this.$store.getters.user.id}
            })
        }
